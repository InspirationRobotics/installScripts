...
function install_robosub {
    [ ! -d "/home/inspiration/auv" ] && echo "Downloading AUV code..." && sudo -u $SUDO_USER git clone https://github.com/InspirationRobotics/robosub_2024.git && mv /home/inspiration/robosub_2024 /home/inspiration/auv && cd auv && sudo -u $SUDO_USER git checkout Revamp && cd /home/inspiration/
